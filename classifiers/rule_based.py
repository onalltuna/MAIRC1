...
rules = {
    ...
    "reqalts": ["anything else", "what else", "how about", "what about", "are there", "can you tell me", "next one", "another", "other", "different", "do you have any", "is that the only one with", "what is available"],
    "reqmore": ["more"],
